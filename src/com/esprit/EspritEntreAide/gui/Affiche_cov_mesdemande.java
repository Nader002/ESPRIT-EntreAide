 ...
 * @author me
 */
public class Affiche_cov_mesdemande extends BaseForm{
    ...
    {     
        ...
        Button btsupp = new Button("supp");
          btsupp.addActionListener((l)->{
            Affiche_cov_mesdemande c = new Affiche_cov_mesdemande(theme);
            c.supp_cov_demande(e);
            Affiche_cov_mesdemande c2 = new Affiche_cov_mesdemande(theme);
            c2.show();
    ...
    public Affiche_cov_mesdemande(Resources res) {
        super("Mes Demandes", BoxLayout.y());
...
//          });
          ...
          listcovs=servicecov.getListmesdemandecov();
     ...
     public void supp_cov_demande(Covoiturage cov)
    {
          ServiceCov servicecov=new ServiceCov();
          servicecov.SuppCovDemande(cov);  
    }
