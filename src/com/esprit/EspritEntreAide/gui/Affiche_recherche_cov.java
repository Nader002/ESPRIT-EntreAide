 ...
 * @author me
 */
public class Affiche_recherche_cov extends BaseForm {
    ...
    public Container addItem(Covoiturage e) {
        ...
        Button btreserve = new Button("Reserver");
        btreserve.addActionListener((l)->{
            Affiche_cov_inforeservation c = new Affiche_cov_inforeservation(e.getId_cov(),theme);
            c.show();
           });
    ...
    public Affiche_recherche_cov(Resources res,String ville_arrive) {
        super("List Des Offres Recherché", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("List Des Offres Recherché");
        ...
        listcovs = servicecov.getListRechercheoffrecov(ville_arrive);
